...
function CreateUser() {
  let [reg,setReg] =useState(0)
    let {register,handleSubmit,formState:{errors}}=useForm();
   let submitForm=(userObj)=>{
            axios.post("http://localhost:4000/hospitals",userObj)
...
{
reg==1 && <h2 className=' text-center display-5 text-success'>Form Registered Successfully</h2>
}
